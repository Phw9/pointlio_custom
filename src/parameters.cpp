...
void readParameters(ros::NodeHandle &nh)
{
  ...
  nh.param<double>("preprocess/blind_for_human_pilot", p_pre->blind_for_human_pilot_, 0.5);
  nh.param<bool>("trajectory_save/traj_save_en", traj_save_en, "false");
  nh.param<std::string>("trajectory_save/traj_file_path", traj_save_path, "/home/catkin_ws/src/result/traj.txt");
